<template>
	<div>
		<div class="container">
			<firm-center-nav path="schedule"></firm-center-nav>
          ...
          <el-col :span="8">
            <el-input v-model="form.keywords">
              <el-button slot="append" icon="el-icon-search" @click="getList"></el-button>
					...
					<el-col :span="3">
						<el-button type="success" @click.native="doEmploy">移动到录用</el-button>
					</el-col>
					<el-col :span="2">
...
<script type="text/ecmascript-6">
  ...
  import {getRecruitList} from '~/API/firm';
	...
	export default  {
        ...
        let {data: list, total:total} = await getRecruitList({pageNo: 1, pageSize: 5, status: 3, viewType:1, sortBy:1, jobId: query.jobId||''});
				return {
          sortByTypes,
          viewTypes,
          total,
