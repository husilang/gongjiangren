<template>
	<div>
		<div class="container">
			<firm-center-nav path="pool"></firm-center-nav>
          ...
          <el-col :span="8">
            <el-input v-model="form.keywords">
              <el-button slot="append" icon="el-icon-search" @click="getList"></el-button>
					...
					<el-col :span="3">
						<el-button type="success" @click.native="moveToWait">移动到待沟通</el-button>
					</el-col>
          <el-col :span="2">
...
<script type="text/ecmascript-6">
  ...
  import {getRecruitList} from '~/API/firm';
	...
	export default  {
        ...
        let {data: list, total:total} = await getRecruitList({pageNo: 1, pageSize: 5, status:1, viewType:1, sortBy:1});
				return {
          sortByTypes,
          viewTypes,
          total,
