<style lang="less" scoped>
  ...
  .main{
    ...
    .search-info{
      background: #f4fbff url("~/assets/icon/count-icon.png") no-repeat 23px 17px;
      ...
      <div class="commonWidth clearfix">
        <div class="fl">
          <ul>
            ...
            <nuxt-link tag="li" to="/client/job-search" class="cur">职位搜索</nuxt-link>
